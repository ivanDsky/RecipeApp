...
class RecipeAdapter(fingerprints: List<RecipeFingerprint<*, RecipeUI>>) :
    BaseAdapter<RecipeUI>(fingerprints as List<BaseFingerprint<*, RecipeUI>>) {
    override val Diff: DiffUtil.ItemCallback<RecipeUI> = RecipeDiff()

    private class RecipeDiff : DiffUtil.ItemCallback<RecipeUI>(){
